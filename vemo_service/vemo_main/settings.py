"""
Django settings for vemo_main project.
...
INSTALLED_APPS = [
    ...
    'vemo_service_apps.auths',
    'vemo_service_apps.auths_api',

    'vemo_service_apps.catalogo',
    'vemo_service_apps.catalogo_api',
...
WSGI_APPLICATION = 'vemo_main.wsgi.application'
