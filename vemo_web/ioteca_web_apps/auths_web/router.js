...
//==================================
    ...
    .state('auths.hierarchy', {
     ...
     .state("auths.hierarchy.hierarchy_type", {
        ...
        templateUrl: "vemo_web_apps/auths_web/views/hierarchy_type/index.html"
    })

    .state("auths.system.permission", {
        url: "/permission",
        data: { section: 'System', page: 'Permisos' },
        templateUrl: "vemo_web_apps/auths_web/views/permission/index.html"
    })
    .state("auths.system.contenttype", {
        url: "/contenttype",
        data: { section: 'System', page: 'Aplicaciones' },
        templateUrl: "vemo_web_apps/auths_web/views/contenttype/index.html"
    })
